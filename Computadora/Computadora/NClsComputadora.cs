...
namespace Computadora.Negocio
{
    class NClsComputadora
    {
       ...
       public String Apagar (ClsComputadora computadora)
       {
            ...
            return " El mouse de la computadora " + computadora.Mouse + " Con el monitor de " + computadora.Monitor + " Estan apagandose ";
        ...
        {
            return " El mouse " + computadora.Mouse + " No está puesto ";
